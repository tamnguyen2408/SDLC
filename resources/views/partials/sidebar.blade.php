<div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
    ...
    <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
        ...
        <li class="nav-title">Managemnents</li>
        <li class="nav-item">
            <a class="nav-link" href="{{ route('admin.song') }}">
                <svg class="nav-icon">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('admin.singer') }}">
                <svg class="nav-icon">
        ...
        {{-- <li class="nav-item">
            <a class="nav-link nav-link-danger" href="https://coreui.io/pro/" target="_top">
                <svg class="nav-icon">
                    <use xlink:href="{{ asset('admin/vendors/@coreui/icons/svg/free.svg#cil-layers') }}"></use>
                </svg>Tune source - 
                <div class="fw-semibold">IT0602</div>
            </a>
        </li> --}}
    </ul>
