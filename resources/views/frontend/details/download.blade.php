                    ...
                    <tbody>
                        @foreach ($song as $item)
                            <tr class="hover-effect">
                                ...
                                <td>
                                    <a href="{{ asset('uploads/songs/' . $item->source) }}" download="{{ $item->name }}" class="btn btn-primary download-btn">Download</a>
                                    {{-- <a href="{{ route('user.download', ['id' => $item->id]) }}" class="btn btn-primary">Download</a> --}}
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
